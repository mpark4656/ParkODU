...
public class PermitTypeRepositoryTests {
    ...
    private PermitType entityOne;
    private PermitType entityTwo;

    private List<PermitType> entities;
    private Set<String> keys;

    @Before
    public void setup() {
        entityOne = new PermitType();
        entityOne.setPermitTypeKey(UUID1);

        entityTwo = new PermitType();
        entityTwo.setPermitTypeKey(UUID2);
        ...
        repository = new PermitTypeRepository(hazelcastInstance, COLLECTION_NAME);
