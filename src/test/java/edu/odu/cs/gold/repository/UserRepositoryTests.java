...
public class UserRepositoryTests {
    ...
    private User entityOne;
    private User entityTwo;
    ...
    public void setup() {
        entityOne = new User();
        entityOne.setUserKey(UUID1);

        entityTwo = new User();
        entityTwo.setUserKey(UUID2);
        ...
        repository = new UserRepository(hazelcastInstance, COLLECTION_NAME);
