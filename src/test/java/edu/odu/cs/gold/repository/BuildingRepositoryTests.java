...
public class BuildingRepositoryTests {
    ...
    private Building entityOne;
    private Building entityTwo;

    private List<Building> entities;
    private Set<String> keys;

    @Before
    public void setup() {
        entityOne = new Building();
        entityOne.setBuildingKey(UUID1);

        entityTwo = new Building();
        entityTwo.setBuildingKey(UUID2);
        ...
        repository = new BuildingRepository(hazelcastInstance, COLLECTION_NAME);
