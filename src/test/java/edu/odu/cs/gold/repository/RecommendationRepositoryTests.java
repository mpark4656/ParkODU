...
public class RecommendationRepositoryTests {
    ...
    private Recommendation entityOne;
    private Recommendation entityTwo;

    private List<Recommendation> entities;
    private Set<String> keys;

    @Before
    public void setup() {
        entityOne = new Recommendation();
        entityOne.setRecommendationKey(UUID1);

        entityTwo = new Recommendation();
        entityTwo.setRecommendationKey(UUID2);
        ...
        repository = new RecommendationRepository(hazelcastInstance, COLLECTION_NAME);
