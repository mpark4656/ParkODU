...
public class FloorRepositoryTests {
    ...
    private Floor entityOne;
    private Floor entityTwo;

    private List<Floor> entities;
    private Set<String> keys;

    @Before
    public void setup() {
        entityOne = new Floor();
        entityOne.setFloorKey(UUID1);

        entityTwo = new Floor();
        entityTwo.setFloorKey(UUID2);
        ...
        repository = new FloorRepository(hazelcastInstance, COLLECTION_NAME);
