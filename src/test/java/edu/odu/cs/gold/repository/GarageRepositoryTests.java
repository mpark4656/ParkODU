...
public class GarageRepositoryTests {
    ...
    private Garage entityOne;
    private Garage entityTwo;

    private List<Garage> entities;
    private Set<String> keys;

    @Before
    public void setup() {
        entityOne = new Garage();
        entityOne.setGarageKey(UUID1);

        entityTwo = new Garage();
        entityTwo.setGarageKey(UUID2);
        ...
        repository = new GarageRepository(hazelcastInstance, COLLECTION_NAME);
