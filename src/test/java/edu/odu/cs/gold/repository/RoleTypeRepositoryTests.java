...
public class RoleTypeRepositoryTests {
    ...
    private RoleType entityOne;
    private RoleType entityTwo;

    private List<RoleType> entities;
    private Set<String> keys;

    @Before
    public void setup() {
        entityOne = new RoleType();
        entityOne.setRoleKey(UUID1);

        entityTwo = new RoleType();
        entityTwo.setRoleKey(UUID2);
        ...
        repository = new RoleTypeRepository(hazelcastInstance, COLLECTION_NAME);
